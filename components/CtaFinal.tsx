  ...
  return (
    <section className="bg-green relative overflow-hidden py-24">
      ...
      <div
        ...
        aria-hidden="true"
      >
        <span className="font-serif text-white leading-none" style={{ fontSize: '28rem', opacity: 0.07 }}>
          φ
        </span>
      </div>

      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
        <p className="text-green-pale text-sm font-semibold uppercase tracking-widest mb-4">
          ¿Listo para empezar?
        </p>
        <h2 className="font-serif text-4xl lg:text-5xl text-white mb-6 leading-tight">
          Tu próximo parcial puede ser diferente.
        </h2>
        <p className="text-green-light text-lg mb-10">
          Escribinos hoy y coordinamos tu primera clase.
        </p>
